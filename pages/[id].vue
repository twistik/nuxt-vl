<!--<template>
  <section v-if="user" class="px-6 py-4 grid grid-cols-1 gap-4">
    <div class="max-w-full rounded overflow-hidden shadow-lg px-6 py-4">
      ...
      <div>
      <NuxtLink @click="$router.back()" class="hover:underline inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">Back all users</NuxtLink>
